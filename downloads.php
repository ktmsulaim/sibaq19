...
<html>
	<head>
		<title>Sibaq '19 - Intercollegiate fest | Downloads</title>
...
<!---------------------------------------- main content ---------------------------------------------------------->
			<div class="head-part wrapper1" id="downloads">
				<div class="container">
					<div class="row">
						<div class="col-lg-12 col-md-12 text-center">
							...
							<div class="breadcrumb-modern">
								<ul class="breadcrumb-modern-list">
									...
									<li><a href="<?php echo $_SERVER['PHP_SELF']; ?>">Downloads</a></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="container-fluid">
									<ul class="row">
									<?php
										$get_downloads = mysqli_query($connect, "SELECT * FROM downloads WHERE status = 'publish' ORDER BY id DESC");
										$i = 1;
										while($row = mysqli_fetch_assoc($get_downloads)){
											echo '<a href="'.$row['path'].'" class="col-md-6 dl-item"><span class="count">'.$i.'</span><li>'.$row['item'].'</li></a>';
											$i++;
										}
									?>
